...
return [
    ...
    'the_distance_travel'                            => <<<EOF
 El cliente desea trasladarse desde <strong> :init_address</strong> hasta <strong>:end_address</strong>, la distancia a recorrer es <strong>:distance</strong> 
 en un tiempo aproximado de <strong>:time</strong> horas a una velocidad de <strong>:velocity</strong>. La tarifa es <strong>:tariff</strong>.
EOF,
